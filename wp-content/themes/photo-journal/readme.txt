...
= 1.4.1 (Released: July 11, 2022) =
* Bug Fixed: Code editor text color (Reported by Anna Apollonia)

= 1.4 (Released: June 18, 2022) =
* Bug Fixed: Countdown section not saving AM/PM
* Updated: Blocks and editor block styles

= 1.3 (Released: February 16, 2022) =
* Bug Fixed: Removed extra ; from style
* Updated: WordPress 5.9 ready

= 1.2.6 (Released: March 18, 2021) =
* Updated: Screenshot Image

= 1.2.5 (Released: March 16, 2021) =
* Bug Fixed: Portfolio thumbnail link issue
...
Photo Journal WordPress Theme, Copyright 2012-2022 Catchthemes.com
