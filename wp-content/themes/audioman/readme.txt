...
= 2.2.3 (Released: February 21, 2022) =
* Bug Fixed: ECT Testimonial Title/Subtitle issue

= 2.2.2 (Released: February 05, 2022) =
* Updated: WordPress 5.9 ready

= 2.2.1 (Released: January 04, 2022) =
* Bug Fixed: Header video issue in Safari

= 2.2 (Released: December 09, 2021) =
...
* Bug Fixed: Z-index issue when on menu when slider is activated

= 2.0.7 (Released: February 03, 2020) =
* Bug Fixed: Breadcrumb issue with disabled on homepage

= 2.0.6 (Released: January 31, 2020) =
* Bug Fixed: Data sanitization issue Number Range function

= 2.0.5 (Released: January 31, 2020) =
...
* Bug Fixed: Code tag color issue in editor style
...
Audioman WordPress Theme, Copyright 2012-2022 Catchthemes.com
