...
= 1.2 (Released: June 09, 2021) =
* Added: Enqueue Languages folder
* Bug Fixed: Multi flex-height, changed to flex-height and flex-width
* Bug Fixed: CSS Update
* Bug Fixed: Colors and font issues
...
Music Journal WordPress Theme, Copyright 2012-2022 Catchthemes.com
